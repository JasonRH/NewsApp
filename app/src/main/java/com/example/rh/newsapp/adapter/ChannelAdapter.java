...
import com.example.rh.newsapp.listener.OnDragVHListener;
import com.example.rh.newsapp.listener.OnItemMoveListener;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    public ChannelAdapter(Context context, ItemTouchHelper helper, List<Channel> mMyChannelItems, List<Channel> mOtherChannelItems) {
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        Channel item = mMyChannelItems.get(startPosition);
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        Channel item = mOtherChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        Channel item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
     ...
     * 将更新完的频道保存到数据库
     */
    public boolean savaChannel() {
       return ChannelDao.save(mMyChannelItems, mOtherChannelItems);
    }
