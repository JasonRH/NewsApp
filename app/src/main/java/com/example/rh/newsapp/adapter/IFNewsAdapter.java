 ...
 * @date 2018/4/14
 */
public class IFNewsAdapter extends BaseMultiItemQuickAdapter<NewsDetailBean.ItemBean, BaseViewHolder> {
    /**
     ...
     */
    public IFNewsAdapter(List<NewsDetailBean.ItemBean> data) {
        super(data);
    ...
    @Override
    protected void convert(BaseViewHolder viewHolder, NewsDetailBean.ItemBean bean) {
